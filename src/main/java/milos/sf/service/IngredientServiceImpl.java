...
import milos.sf.Domain.Ingredient;
import milos.sf.Domain.Recipe;
import milos.sf.commands.IngredientCommand;
import milos.sf.converters.IngredientCommandToIngredient;
import milos.sf.converters.IngredientToIngredientCommand;
        ...
        if(!recipeOptional.isPresent()) {
            ...
            if(ingredientOptional.isPresent()) {
                ...
                ingredientFound.setUom(unitOfMeasureRepository.findById(command.getUom().getId())
                                .orElseThrow(() -> new RuntimeException("OUM NOT FOUND")));  // todo address this
            } else {
                //add new Ingredient
